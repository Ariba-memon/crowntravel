    ...
    <div ref={ref}>
      <div className="mt-1 relative">
        <button
          ...
          } relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-stone-500 focus:border-stone-500 sm:text-sm`}
              ...
              <div className="sticky top-0 z-10 bg-white">
                <li className=" text-gray-900 cursor-default select-none relative py-2 px-3">
                  <input
                    ...
                    name="search"
                    autoComplete={"off"}
                    className="py-2 px-2 focus:ring-stone-500 focus:border-stone-500 block w-full sm:text-sm border-gray-300 rounded-md"
                    ...
                    return (
                      ...
                      >
                        ...
                        {value.value === selectedValue.value ? (
                          <span className="text-stone-600 absolute inset-y-0 right-0 flex items-center pr-8">
                            <svg
                              className="h-5 w-5"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 20 20"
